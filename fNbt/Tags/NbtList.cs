...
{
    [JetBrains.Annotations.NotNull] private readonly List<NbtTag> _tags = [];
    ...
    public NbtList([JetBrains.Annotations.NotNull] IEnumerable<NbtTag> tags)
    ...
    /// <exception cref="ArgumentNullException"> <paramref name="tags" /> is <c>null</c>. </exception>
    /// <exception cref="ArgumentException"> If given tags are of mixed types. </exception>
    public NbtList([CanBeNull] string tagName, [JetBrains.Annotations.NotNull] IEnumerable<NbtTag> tags)
    ...
    ///     types.
    /// </exception>
    public NbtList([JetBrains.Annotations.NotNull] IEnumerable<NbtTag> tags, NbtTagType givenListType)
    ...
    public NbtList([JetBrains.Annotations.NotNull] NbtList other)
    {
    ...
    [SuppressMessage("Style", "IDE0048:Add parentheses for clarity", Justification = "<Pending>")]
    public NbtTagType ListType
    {
        ...
        set
        {
            ...
            else if (value is < NbtTagType.Byte or > NbtTagType.LongArray and not NbtTagType.Unknown)
            {
    ...
    public void AddRange([JetBrains.Annotations.NotNull] IEnumerable<NbtTag> newTags)
    {
    ...
    internal override bool ReadTag(NbtBinaryReader readStream)
    {
        ...
        for (var i = 0; i < length; i++)
        {
            NbtTag newTag = ListType switch
            {
                ...
                _ => throw new NbtFormatException("Unsupported tag type found in a list: " +
                                                  ListType) // should never happen, since ListType is checked beforehand
            };
            newTag.Parent = this;
    ...
    public void Clear()
    {
        foreach (var tag in _tags) tag.Parent = null;
