...
/// </summary>
internal sealed class NbtBinaryReader([NotNull] Stream input, bool bigEndian) : BinaryReader(input)
{
    ...
    private readonly bool _swapNeeded = BitConverter.IsLittleEndian == bigEndian;
